...
import j$2 from 'tiny-invariant';
...
import x$2 from 'react-dom/server';
...
const appConfig$1 = {"name":"vinxi","routers":[{"name":"public","type":"static","dir":"./public","base":"/","root":"/Users/ross/projects/hello-fresh-load","order":0,"outDir":"/Users/ross/projects/hello-fresh-load/.vinxi/build/public"},{"name":"client","type":"client","target":"browser","handler":"app/client.tsx","base":"/_build","build":{"sourcemap":true},"root":"/Users/ross/projects/hello-fresh-load","outDir":"/Users/ross/projects/hello-fresh-load/.vinxi/build/client","order":1},{"name":"ssr","type":"http","target":"server","handler":"app/ssr.tsx","link":{"client":"client"},"root":"/Users/ross/projects/hello-fresh-load","base":"/","outDir":"/Users/ross/projects/hello-fresh-load/.vinxi/build/ssr","order":2},{"name":"server","type":"http","target":"server","base":"/_server","handler":"node_modules/@tanstack/start/dist/esm/server-handler/index.js","root":"/Users/ross/projects/hello-fresh-load","outDir":"/Users/ross/projects/hello-fresh-load/.vinxi/build/server","order":3}],"server":{"preset":"bun","experimental":{"asyncContext":true}},"root":"/Users/ross/projects/hello-fresh-load"};
				const buildManifest = {"client":{"/Users/ross/projects/hello-fresh-load/app/global.css":{"file":"assets/global-BMbyHcbr.css","src":"/Users/ross/projects/hello-fresh-load/app/global.css"},"_client-wJQXdkEg.js":{"file":"assets/client-wJQXdkEg.js","name":"client","dynamicImports":["app/routes/index.tsx?tsr-split","app/routes/index.tsx?tsr-split"],"assets":["assets/global-BMbyHcbr.css"]},"app/routes/index.tsx?tsr-split":{"file":"assets/index-DOygdo6J.js","name":"index","src":"app/routes/index.tsx?tsr-split","isDynamicEntry":true,"imports":["_client-wJQXdkEg.js"]},"virtual:$vinxi/handler/client":{"file":"assets/client-nzzaGE2g.js","name":"client","src":"virtual:$vinxi/handler/client","isEntry":true,"imports":["_client-wJQXdkEg.js"]}},"ssr":{"/Users/ross/projects/hello-fresh-load/app/global.css":{"file":"assets/global-BMbyHcbr.css","src":"/Users/ross/projects/hello-fresh-load/app/global.css"},"_ssr-B4m0jinu.js":{"file":"assets/ssr-B4m0jinu.js","name":"ssr","dynamicImports":["app/routes/index.tsx?tsr-split","app/routes/index.tsx?tsr-split"],"assets":["assets/global-BMbyHcbr.css"]},"app/routes/index.tsx?tsr-split":{"file":"assets/index-tDOaAM9_.js","name":"index","src":"app/routes/index.tsx?tsr-split","isDynamicEntry":true,"imports":["_ssr-B4m0jinu.js"]},"virtual:$vinxi/handler/ssr":{"file":"ssr.js","name":"ssr","src":"virtual:$vinxi/handler/ssr","isEntry":true,"imports":["_ssr-B4m0jinu.js"]}},"server":{"app/services/recipes.service.ts":{"file":"c_tnh0t1.mjs","name":"c_tnh0t1","src":"app/services/recipes.service.ts","isEntry":true},"virtual:$vinxi/handler/server":{"file":"entry.mjs","name":"entry","src":"virtual:$vinxi/handler/server","isEntry":true}}};
...
function R$2(e,r,n){return Object.assign(e,{url:"https://localhost:3000"})}function C$1(e){return e instanceof Headers?new Headers(e):Array.isArray(e)?new Headers(e):typeof e=="object"?new Headers(e):new Headers}function q(...e){return e.reduce((r,n)=>{const i=C$1(n);for(const[o,a]of i.entries())r.set(o,a);return r},new Headers)}function g(e,r){const n=r||e||{};return typeof n.method>"u"&&(n.method="GET"),{options:n,middleware:i=>g(void 0,Object.assign(n,{middleware:i})),validator:i=>g(void 0,Object.assign(n,{validator:i})),handler:(...i)=>{const[o,a]=i;Object.assign(n,{...o,extractedFn:o,serverFn:a}),j$2(o.url,"createServerFn must be called with a function that is marked with the 'use server' pragma. Are you using the @tanstack/start-vite-plugin ?");const d=[...n.middleware||[],j$1(n)];return Object.assign(async l=>E(d,"client",{...o,method:n.method,data:l?.data,headers:l?.headers,context:Object.assign({},o)}).then(s=>s.result),{...o,__executeServer:l=>{const s=l instanceof FormData?F$1(l):l;return E(d,"server",{...o,...s}).then(y=>({result:y.result,context:y.sendContext}))}})}}}function F$1(e){const r=e.get("__TSR_CONTEXT");if(e.delete("__TSR_CONTEXT"),typeof r!="string")return {context:{},data:e};try{return {context:defaultTransformer.parse(r),data:e}}catch{return {data:e}}}function U$1(e){const r=[],n=i=>{i.forEach(o=>{o.options.middleware&&n(o.options.middleware),r.push(o);});};return n(e),r}const T=(e,r,n)=>e({data:r.data,context:r.context,sendContext:r.sendContext,method:r.method,next:i=>{const o={...r.context,...i?.context},a={...r.sendContext,...i?.sendContext??{}},d=q(r.headers,i?.headers);return n({method:r.method,data:r.data,context:o,sendContext:a,headers:d,result:i?.result??r.result})}});function I$2(e,r){if(e==null)return {};if("~standard"in e){const n=e["~standard"].validate(r);if(n instanceof Promise)throw new Error("Async validation not supported");if(n.issues)throw new Error(JSON.stringify(n.issues,void 0,2));return n.value}if("parse"in e)return e.parse(r);if(typeof e=="function")return e(r);throw new Error("Invalid validator type!")}async function E(e,r,n){const i=U$1(e),o=async a=>{const d=i.shift();if(!d)return a;d.options.validator&&(r!=="client"||d.options.validateClient)&&(a.data=await I$2(d.options.validator,a.data));const l=r==="client"?d.options.client:d.options.server;return l?T(l,a,async s=>{if(r==="client"&&d.options.clientAfter){const y=await o(s);return T(d.options.clientAfter,y,M=>M)}return o(s)}):o(a)};return o({...n,headers:n.headers||{},sendContext:n.sendContext||{},context:n.context||{}})}function j$1(e){return {_types:void 0,options:{validator:e.validator,validateClient:e.validateClient,client:async({next:r,sendContext:n,...i})=>{var o;const a=await((o=e.extractedFn)==null?void 0:o.call(e,{...i,context:n}));return r(a)},server:async({next:r,...n})=>{var i;const o=await((i=e.serverFn)==null?void 0:i.call(e,n));return r({result:o})}}}}const h=sqliteTable("category",{id:integer("id").primaryKey(),slug:text("slug").unique().notNull(),name:text("name").notNull(),type:text("type"),icon_path:text("icon_path"),icon_link:text("icon_link"),created_at:text("created_at").notNull().default(sql`(CURRENT_TIMESTAMP)`),updated_at:text("updated_at").notNull().default(sql`(CURRENT_TIMESTAMP)`).$onUpdate(()=>sql`(CURRENT_TIMESTAMP)`)}),u=sqliteTable("recipes",{id:integer("id").primaryKey(),oid:text("oid").unique().notNull(),category_id:integer("category_id").notNull().references(()=>h.id,{onDelete:"cascade"}),name:text("name").notNull(),slug:text("slug").notNull(),headline:text("headline"),description:text("description"),difficulty:text("difficulty"),prep_time:text("prep_time"),total_time:text("total_time"),image_path:text("image_path"),card_link:text("card_link"),average_rating:text("average_rating"),ratings_count:text("ratings_count"),favorites_count:text("favorites_count"),is_premium:text("is_premium"),website_url:text("website_url"),created_at:text("created_at").notNull().default(sql`(CURRENT_TIMESTAMP)`),updated_at:text("updated_at").notNull().default(sql`(CURRENT_TIMESTAMP)`).$onUpdate(()=>sql`(CURRENT_TIMESTAMP)`)}),v$1=sqliteTable("ingredients",{id:integer("id").primaryKey(),oid:text("oid").unique().notNull(),recipe_id:integer("recipe_id").notNull().references(()=>u.id,{onDelete:"cascade"}),name:text("name").notNull()}),w$2=sqliteTable("utensils",{id:integer("id").primaryKey(),oid:text("oid").unique().notNull(),recipe_id:integer("recipe_id").notNull().references(()=>u.id,{onDelete:"cascade"}),name:text("name").notNull()}),m=sqliteTable("steps",{id:integer("id").primaryKey(),oid:text("oid").unique().notNull(),recipe_id:integer("recipe_id").notNull().references(()=>u.id,{onDelete:"cascade"}),index:integer("index").notNull(),instructions:text("instructions").notNull()}),k$1=sqliteTable("images",{id:integer("id").primaryKey(),oid:text("oid").unique().notNull(),step_id:integer("step_id").notNull().references(()=>m.id,{onDelete:"cascade"}),link:text("link"),path:text("path"),caption:text("caption")}),H$2=sqliteTable("timers",{id:integer("id").primaryKey(),oid:text("oid").unique().notNull(),step_id:integer("step_id").notNull().references(()=>m.id,{onDelete:"cascade"}),name:text("name"),duration:text("duration"),temperature:text("temperature"),temperature_unit:text("temperature_unit"),oven_mode:text("oven_mode")}),P$1=Object.freeze(Object.defineProperty({__proto__:null,categories:h,images:k$1,ingredients:v$1,recipes:u,steps:m,timers:H$2,utensils:w$2},Symbol.toStringTag,{value:"Module"})),x=drizzle("file:recipes.db",{schema:P$1}),K=b(),D$1=g({method:"GET"}).handler(R$2(J$1),async()=>{K.info("fetching random recipe");const r=(await x.select({id:u.id}).from(u).where(sql$1`(SELECT COUNT(*) FROM ingredients WHERE ingredients.recipe_id = recipes.id) > 3`).orderBy(sql$1`RANDOM()`).limit(1))[0].id,n=await x.select().from(u).leftJoin(h,eq(u.category_id,h.id)).leftJoin(m,eq(u.id,m.recipe_id)).leftJoin(v$1,eq(v$1.recipe_id,u.id)).leftJoin(w$2,eq(w$2.recipe_id,u.id)).where(eq(u.id,r)),i=n.map(s=>s.steps?.instructions),o=n.map(s=>s.ingredients?.name),a=new Set(i.filter(s=>s!==void 0)),d=new Set(o.filter(s=>s!==void 0));return {...n[0].recipes,id:void 0,steps:Array.from(a),ingredients:Array.from(d)}});function J$1(e){return D$1.__executeServer(e)}

const mod_0_3 = /*#__PURE__*/Object.freeze({
	__proto__: null,
	$$function0: J$1,
	fetchRandomRecipe: D$1
});

const chunks = {};
				chunks['c_tnh0t1.mjs'] = mod_0_3;
...
const assets$1 = {
  "/_build/server-functions-manifest.json": {
    ...
    "etag": "\"60-8rgxyCnD3qVAdZuPcL1GWS2StSM\"",
    "mtime": "2024-12-07T15:17:02.669Z",
    "size": 96,
    "path": "../public/_build/server-functions-manifest.json"
  },
  "/assets/global-BMbyHcbr.css": {
    "type": "text/css; charset=utf-8",
    "etag": "\"33ac-zpZn5A4GAnYpjiEYxXyhjhcZRmQ\"",
    "mtime": "2024-12-07T15:17:02.671Z",
    "size": 13228,
    "path": "../public/assets/global-BMbyHcbr.css"
  },
  "/_build/.vite/manifest.json": {
    "type": "application/json",
    "etag": "\"376-Wtugg4DT51ckmIJ+tSR7LXjHvaw\"",
    "mtime": "2024-12-07T15:17:02.670Z",
    "size": 886,
    "path": "../public/_build/.vite/manifest.json"
  },
  "/_build/assets/client-nzzaGE2g.js": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"3f-thvqZm5tjjbq5668l9DTFaMuPys\"",
    "mtime": "2024-12-07T15:17:02.669Z",
    "size": 63,
    "path": "../public/_build/assets/client-nzzaGE2g.js"
  },
  "/_build/assets/client-wJQXdkEg.js": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"3cf6c-kAp6c4CFneU8q9VZOm1Nfv1YITQ\"",
    "mtime": "2024-12-07T15:17:02.669Z",
    "size": 249708,
    "path": "../public/_build/assets/client-wJQXdkEg.js"
  },
  "/_build/assets/global-BMbyHcbr.css": {
    "type": "text/css; charset=utf-8",
    "etag": "\"33ac-zpZn5A4GAnYpjiEYxXyhjhcZRmQ\"",
    "mtime": "2024-12-07T15:17:02.669Z",
    "size": 13228,
    "path": "../public/_build/assets/global-BMbyHcbr.css"
  },
  "/_build/assets/index-DOygdo6J.js": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"bd3b-fGPQwndliNP7lEguCZ+OjmUXa6k\"",
    "mtime": "2024-12-07T15:17:02.669Z",
    "size": 48443,
    "path": "../public/_build/assets/index-DOygdo6J.js"
  }
};
...
const _qqeF7Z = eventHandler((event) => {
...
function F(e){let n;const t=R$1(e),s={duplex:"half",method:e.method,headers:e.headers};return e.node.req.body instanceof ArrayBuffer?new Request(t,{...s,body:e.node.req.body}):new Request(t,{...s,get body(){return n||(n=W$1(e),n)}})}function L$1(e){return e.web??={request:F(e),url:R$1(e)},e.web.request}function H$1(){return S()}const w$1=Symbol("$HTTPEvent");function O(e){return typeof e=="object"&&(e instanceof H3Event||e?.[w$1]instanceof H3Event||e?.__is_event__===!0)}function l(e){return function(...n){let t=n[0];if(O(t))n[0]=t instanceof H3Event||t.__is_event__?t:t[w$1];else {if(!globalThis.app.config.server.experimental?.asyncContext)throw new Error("AsyncLocalStorage was not enabled. Use the `server.experimental.asyncContext: true` option in your app configuration to enable it. Or, pass the instance of HTTPEvent that you have as the first argument to the function.");if(t=H$1(),!t)throw new Error("No HTTPEvent found in AsyncLocalStorage. Make sure you are using the function within the server runtime.");n.unshift(t);}return e(...n)}}const R$1=l(getRequestURL),P=l(getResponseStatus),W$1=l(getRequestWebStream);function I$1(){return getContext("nitro-app",{asyncContext:!!globalThis.app.config.server.experimental?.asyncContext,AsyncLocalStorage:AsyncLocalStorage})}function S(){return I$1().use().event}function U(e){return globalThis.MANIFEST[e]}const G=eventHandler(j);async function j(e){return J(L$1(e))}async function J(e,n){var t,s;const p=e.method,T=new URL(e.url,"http://localhost:3000"),a=Object.fromEntries(T.searchParams.entries()),i=a._serverFnId,d=a._serverFnName;if(!i||!d)throw new Error("Invalid request");j$2(typeof i=="string","Invalid server action");const b=(s=await((t=U("server").chunks[i])==null?void 0:t.import()))==null?void 0:s[d],u=await(async()=>{try{const r=await(async()=>{var y;if((y=e.headers.get("Content-Type"))!=null&&y.includes("multipart/form-data"))return j$2(p.toLowerCase()!=="get","GET requests with FormData payloads are not supported"),await e.formData();if(p.toLowerCase()==="get")return a.payload?defaultTransformer.parse(a.payload):void 0;const x=await e.text();return defaultTransformer.parse(x)})(),o=await b(r);return o instanceof Response?o:isRedirect$1(o)||isNotFound(o)?v(o):new Response(o!==void 0?defaultTransformer.stringify(o):void 0,{status:P(S()),headers:{"Content-Type":"application/json"}})}catch(r){return r instanceof Response?r:isRedirect$1(r)||isNotFound(r)?v(r):(console.error("Server Fn Error!"),console.error(r),console.info(),new Response(JSON.stringify(r),{status:500,headers:{"Content-Type":"application/json"}}))}})();if(u.headers.get("Content-Type")==="application/json"){const o=await u.clone().text();o&&JSON.stringify(JSON.parse(o));}return u}function v(e){const{headers:n,...t}=e;return new Response(JSON.stringify(t),{status:200,headers:{"Content-Type":"application/json",...e.headers||{}}})}
...
function de(e) {
  ...
  if (s !== void 0 || o !== void 0 || (n == null ? void 0 : n.length)) {
    const a = `__TSR__.initMatch(${S$1({ index: e.matchIndex, __beforeLoadContext: r.options.transformer.stringify(s), loaderData: r.options.transformer.stringify(o), extracted: n ? Object.fromEntries(n.map((i) => [i.id, pick(i, ["type", "path"])])) : {} }, { isScriptContext: true, wrap: true, json: true })})`;
    return jsxs(Fragment, { children: [jsx(ScriptOnce, { children: a }), n ? n.map((i) => i.type === "stream" ? jsx(he, { entry: i }, i.id) : jsx(fe, { entry: i }, i.id)) : null] });
  }
  return null;
}
function w(e, r, t = []) {
...
function fe({ entry: e }) {
  return jsx("div", { className: "tsr-once", children: jsx(y.Suspense, { fallback: null, children: jsx(me, { entry: e }) }) });
}
function me({ entry: e }) {
  const r = useRouter();
...
function he({ entry: e }) {
  j$2(e.streamState, "StreamState should be defined");
  const r = useRouter();
...
function k({ streamState: e, children: r, __index: t = 0 }) {
  ...
  const s = n.value;
  return jsxs(Fragment, { children: [r(s), jsx("div", { className: "tsr-once", children: jsx(y.Suspense, { fallback: null, children: jsx(k, { streamState: e, __index: t + 1, children: r }) }) })] });
}
function H(e, r, t) {
  if (r.length === 0) return t;
  const [n, ...s] = r;
  return Array.isArray(e) ? e.map((o, a) => a === Number(n) ? H(o, s, t) : o) : isPlainObject$1(e) ? { ...e, [n]: H(e[n], s, t) } : e;
}
function C(e) {
  e.router.AfterEachMatch = de, e.router.serializer = (n) => S$1(n, { isScriptContext: true, wrap: true, json: true });
  const r = Context.get("TanStackRouterHydrationContext", {}), t = y.useMemo(() => {
    var n, s;
...
function R(e) {
  return function(...r) {
    var _a;
    let t = r[0];
    if (Se(t)) r[0] = t instanceof H3Event || t.__is_event__ ? t : t[I];
    else {
      if (!((_a = globalThis.app.config.server.experimental) == null ? void 0 : _a.asyncContext)) throw new Error("AsyncLocalStorage was not enabled. Use the `server.experimental.asyncContext: true` option in your app configuration to enable it. Or, pass the instance of HTTPEvent that you have as the first argument to the function.");
      if (t = ge(), !t) throw new Error("No HTTPEvent found in AsyncLocalStorage. Make sure you are using the function within the server runtime.");
      r.unshift(t);
    }
    return e(...r);
  };
}
const dt = R(getRequestHeaders), A = R(getRequestURL), ft = R(getResponseStatus), Re = R(getResponseHeaders), xe = R(getRequestWebStream);
function ve() {
  var _a;
...
function we({ createRouter: e, getRouterManifest: r }) {
  return (t) => eventHandler(async (n) => {
    const s = ye(n), o = new URL(s.url), a = o.href.replace(o.origin, ""), i = createMemoryHistory({ initialEntries: [a] }), c = e();
...
const Me = /(<body)/, qe = /(<\/body>)/, Pe = /(<\/html>)/, $e = /(<\/[a-zA-Z][\w:.-]*?>)/g, ke = new TextDecoder();
function L(e) {
  let r = false, t = "", n = "";
  return { async transform(s, o) {
    const a = t + ke.decode(s), i = a.match(Me), c = a.match(qe), l = a.match(Pe);
    try {
      if (i && (r = true), !r) {
        o(a), t = "";
        return;
      ...
      if (c && l && c.index < l.index) {
        const f = c.index + c[0].length, h = l.index + l[0].length, v = a.slice(0, f) + d + a.slice(f, h) + a.slice(h);
        o(v), t = "";
      } else {
        let f, h = 0;
        for (; (f = $e.exec(a)) !== null; ) h = f.index + f[0].length;
        if (h > 0) {
...
const Ie = async ({ request: e, router: r, responseHeaders: t }) => {
  if (typeof x$2.renderToReadableStream == "function") {
    const n = await x$2.renderToReadableStream(jsx(C, { router: r }), { signal: e.signal });
  ...
  if (typeof x$2.renderToPipeableStream == "function") {
    const n = new PassThrough(), s = x$2.renderToPipeableStream(jsx(C, { router: r }), { ...isbot(e.headers.get("User-Agent")) ? { onAllReady() {
      s.pipe(n);
    } } : { onShellReady() {
      s.pipe(n);
    } }, onError: (i, c) => {
...
}, Ae = () => ({ routes: { __root__: { filePath: "__root.tsx", children: ["/"], preloads: ["/_build/assets/client-nzzaGE2g.js", "/_build/assets/client-wJQXdkEg.js"] }, "/": { filePath: "index.tsx" } } });
function Le(e) {
...
function B({ tag: e, attrs: r, children: t }) {
  switch (e) {
    case "title":
...
const We = () => {
  const e = useRouter(), r = useRouterState({ select: (o) => o.matches.map((a) => a.meta).filter(Boolean) }), t = y.useMemo(() => {
    const o = [], a = {};
    let i;
...
const Fe = () => {
  ...
  return jsx(Fragment, { children: n.map((s, o) => createElement(B, { ...s, key: `tsr-scripts-${s.tag}-${o}` })) });
}, Ne = "/_build/assets/global-BMbyHcbr.css", D = createRootRoute({ head: () => ({ meta: [{ charSet: "utf-8" }, { name: "viewport", content: "width=device-width, initial-scale=1" }, { title: "Ross' Hello Fresh Recipes" }], links: [{ rel: "stylesheet", href: Ne }] }), component: Ue });
function Ue() {
  return jsx(Qe, { children: jsx(Outlet, {}) });
}
function Qe({ children: e }) {
  return jsxs("html", { lang: "en", children: [jsx("head", { children: jsx(je, {}) }), jsxs("body", { children: [e, jsx(ScrollRestoration, {}), jsx(Fe, {})] })] });
}
const Je = () => import('./chunks/build/index-tDOaAM9_.mjs'), Ge = () => import('./chunks/build/index-tDOaAM9_.mjs'), W = createFileRoute("/")({ component: lazyRouteComponent(Ge, "component", () => W.ssr), loader: lazyFn(Je, "loader") }), Ve = W.update({ id: "/", path: "/", getParentRoute: () => D }), Xe = { IndexRoute: Ve }, Ze = D._addFileChildren(Xe)._addFileTypes();
function Ke() {
  return createRouter$2({ routeTree: Ze });
}
const mt = we({ createRouter: Ke, getRouterManifest: De })(Ie);

const handlers = [
  { route: '', handler: _qqeF7Z, lazy: false, middleware: true, method: undefined },
...
storage.mount('data', unstorage_47drivers_47fs_45lite({"driver":"fsLite","base":"/Users/ross/projects/hello-fresh-load/.data/kv"}));
...
export { Le as L, M, W, be as b, dt as d, eventHandler as e, ft as f, node$1 as n, ye as y };
